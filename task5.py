...
defective_prob_l = 0.15  # Probability of receiving a defective item from Leaf First-Aid Kits Ltd
...
print("Probability of receiving a defective item:", total_defective_prob)
...
print("Probability that a defective item came from Uzumaki Safety Suppliers:", prob_defective_from_u)
