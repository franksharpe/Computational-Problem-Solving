...
# Total probability of receiving a defective item
total_defective_prob = prob_defective_u + prob_defective_k + prob_defective_l 
...
print("Probability that a defective item came from \nUzumaki Safety Suppliers:\n", prob_defective_from_u*100,"%")

# (c) Discussion
# Compare the total probability of receiving a defective item before and after introducing Leaf First-Aid Kits Ltd

 # Total probability of receiving a defective item with two suppliers
 
old_total_defective_prob = defective_prob_u + defective_prob_k 

 # Total probability of receiving a defective item with three suppliers

new_total_defective_prob = total_defective_prob  
